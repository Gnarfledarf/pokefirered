...
const u8 gText_LeagueChamp[] = _("League Chamption!\nCongratulations!");
...
const u8 gText_Energypowder_50[] = _("Energy Powder{CLEAR_TO 0x74}{FONT_SMALL}50");
...
const u8 gText_PokedexRegistration[] = _("Pokémon registration completed.");
...
const u8 gText_CannotSendMonToBoxHM[] = _("Cannot send that {PKMN} to the box,\nbecause it knows an HM move.{PAUSE_UNTIL_PRESS}");

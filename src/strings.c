...
const u8 gText_BattleItems2[] = _("BATTLE ITEMS");
const u8 gText_Treasures2[] = _("TREASURES");
...
const u8 gText_BattleItemsPocket[] = _("BATTLE ITEMS POCKET");
const u8 gText_TreasuresPocket[] = _("TREASURE POCKET");

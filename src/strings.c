...
const u8 gText_NextDataCancel[] = _("{A_BUTTON}Next Date {B_BUTTON}Cancel");
const u8 gText_Next[] = _("{A_BUTTON}Next");
const u8 gText_CancelPreviousData[] = _("{A_BUTTON}Cancel {B_BUTTON}Previous Date");
...
const u8 gText_LeagueChamp[] = _("Leage Champion!\nCongratulations!");
...
const u8 gText_Zinc_1000[] = _("Zine{CLEAR_TO 0x65}{FONT_SMALL}1,000");

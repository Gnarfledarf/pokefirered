...
#endif
static const u8 sText_PreventsEscape[] = _("{B_SCR_NAME_WITH_PREFIX} prevents escape with {B_SCR_ACTIVE_ABILITY}!\p");
...
static const u8 sText_PkmnMadeSleep[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_BUFF1} made {B_EFF_NAME_WITH_PREFIX2} sleep!"); //not in gen 5+, ability popup
...
static const u8 sText_PkmnPoisonedBy[] = _("{B_EFF_NAME_WITH_PREFIX} was poisoned by {B_SCR_NAME_WITH_PREFIX2}'s {B_BUFF1}!"); //not in gen 5+, ability popup
...
static const u8 sText_PkmnBurnedBy[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_BUFF1} burned {B_EFF_NAME_WITH_PREFIX2}!"); //not in gen 5+, ability popup
...
static const u8 sText_PkmnFrozenBy[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_BUFF1} froze {B_EFF_NAME_WITH_PREFIX2} solid!"); //not in gen 5+, ability popup
...
static const u8 sText_PkmnWasParalyzedBy[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_BUFF1} paralyzed {B_EFF_NAME_WITH_PREFIX2}, so it may be unable to move!"); //not in gen 5+, ability popup
...
static const u8 sText_PkmnInLove[] = _("{B_ATK_NAME_WITH_PREFIX} is in love with {B_SCR_NAME_WITH_PREFIX2}!");
...
static const u8 sText_PkmnUsedSafeguard[] = _("{B_SCR_NAME_WITH_PREFIX} is protected by Safeguard!");
...
static const u8 sText_PkmnProtectedByMist[] = _("{B_SCR_NAME_WITH_PREFIX} is protected by the mist!");
...
static const u8 sText_PkmnUproarKeptAwake[] = _("But the uproar kept {B_SCR_NAME_WITH_PREFIX2} awake!");
...
static const u8 sText_PkmnHurtBySpikes[] = _("{B_SCR_NAME_WITH_PREFIX} was hurt by the spikes!");
...
static const u8 sText_PkmnSnatchedMove[] = _("{B_DEF_NAME_WITH_PREFIX} snatched {B_SCR_NAME_WITH_PREFIX2}'s move!");
...
static const u8 sText_ForXCommaYZ[] = _("For {B_SCR_NAME_WITH_PREFIX2}, {B_LAST_ITEM} {B_BUFF1}"); //not in gen 5+, expansion doesn't use anymore
static const u8 sText_PkmnUsedXToGetPumped[] = _("{B_SCR_NAME_WITH_PREFIX} used the {B_LAST_ITEM} to get pumped!");
...
static const u8 sText_PkmnMadeItRain[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} made it rain!"); //not in gen 5+, ability popup
static const u8 sText_PkmnRaisedSpeed[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} raised its Speed!"); //not in gen 5+, ability popup
...
static const u8 sText_PkmnCutsAttackWith[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} cuts {B_DEF_NAME_WITH_PREFIX2}'s Attack!"); //not in gen 5+, ability popup
static const u8 sText_PkmnPreventsStatLossWith[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} prevents stat loss!"); //not in gen 5+, ability popup
...
static const u8 sText_PkmnsXBlocksY2[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} blocks {B_CURRENT_MOVE}!"); //not in gen 5+, ability popup
...
static const u8 sText_PkmnsXWhippedUpSandstorm[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} whipped up a sandstorm!"); //not in gen 5+, ability popup
static const u8 sText_PkmnsXIntensifiedSun[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} intensified the sun's rays!"); //not in gen 5+, ability popup
static const u8 sText_PkmnsXPreventsYLoss[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} prevents {B_BUFF1} loss!"); //not in gen 5+, ability popup
...
static const u8 sText_PkmnsXCuredYProblem[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} cured its {B_BUFF1} problem!"); //not in gen 5+, ability popup
static const u8 sText_ItSuckedLiquidOoze[] = _("{B_ATK_NAME_WITH_PREFIX} sucked up the liquid ooze!");
static const u8 sText_PkmnTransformed[] = _("{B_SCR_NAME_WITH_PREFIX} transformed!");
...
static const u8 sText_PreventedFromWorking[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} prevented {B_SCR_NAME_WITH_PREFIX2}'s {B_BUFF1} from working!"); //unused
static const u8 sText_PkmnsXMadeItIneffective[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} made it ineffective!"); //not in gen 5+, ability popup
...
static const u8 sText_PkmnsAbilityPreventsAbility[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} prevents {B_DEF_NAME_WITH_PREFIX2}'s {B_DEF_ABILITY} from working!"); //not in gen 5+, ability popup
static const u8 sText_PkmnsXCuredItsYProblem[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} cured its {B_BUFF1} problem!"); //not in gen 5+, ability popup
static const u8 sText_PkmnsXHadNoEffectOnY[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} had no effect on {B_EFF_NAME_WITH_PREFIX2}!"); //not in gen 5+, ability popup
...
static const u8 sText_UsingItemTheStatOfPkmnRose[] = _("Using {B_LAST_ITEM}, the {B_BUFF1} of {B_SCR_NAME_WITH_PREFIX2} {B_BUFF2}"); //todo: update this, will require code changes
...
static const u8 sText_PkmnsItemCuredParalysis[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} cured its paralysis!");
static const u8 sText_PkmnsItemCuredPoison[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} cured its poison!");
static const u8 sText_PkmnsItemHealedBurn[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} cured its burn!");
static const u8 sText_PkmnsItemHealedFrostbite[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} cured its frostbite!");
static const u8 sText_PkmnsItemDefrostedIt[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} defrosted it!");
static const u8 sText_PkmnsItemWokeIt[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} woke it up!");
static const u8 sText_PkmnsItemSnappedOut[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} snapped it out of its confusion!");
static const u8 sText_PkmnsItemCuredProblem[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} cured its {B_BUFF1} problem!");
static const u8 sText_PkmnsItemNormalizedStatus[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} normalized its status!");
static const u8 sText_PkmnsItemRestoredHealth[] = _("{B_SCR_NAME_WITH_PREFIX} restored its health using its {B_LAST_ITEM}!");
static const u8 sText_PkmnsItemRestoredPP[] = _("{B_SCR_NAME_WITH_PREFIX} restored PP to its move {B_BUFF1} using its {B_LAST_ITEM}!");
static const u8 sText_PkmnsItemRestoredStatus[] = _("{B_SCR_NAME_WITH_PREFIX} returned its stats to normal using its {B_LAST_ITEM}!");
static const u8 sText_PkmnsItemRestoredHPALittle[] = _("{B_SCR_NAME_WITH_PREFIX} restored a little HP using its {B_LAST_ITEM}!");
...
static const u8 sText_AllySwitchPosition[] =_("{B_ATK_NAME_WITH_PREFIX} and {B_SCR_NAME_WITH_PREFIX2} switched places!");
...
static const u8 sText_ScriptingAbilityRaisedStat[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} raised its {B_BUFF1}!");
...
static const u8 sText_MoldBreakerEnters[] = _("{B_SCR_NAME_WITH_PREFIX} breaks the mold!");
static const u8 sText_TeravoltEnters[] = _("{B_SCR_NAME_WITH_PREFIX} is radiating a bursting aura!");
static const u8 sText_TurboblazeEnters[] = _("{B_SCR_NAME_WITH_PREFIX} is radiating a blazing aura!");
static const u8 sText_SlowStartEnters[] = _("{B_SCR_NAME_WITH_PREFIX} is slow to get going!");
...
static const u8 sText_AnticipationActivates[] = _("{B_SCR_NAME_WITH_PREFIX} shuddered!");
static const u8 sText_ForewarnActivates[] = _("{B_SCR_ACTIVE_ABILITY} alerted {B_SCR_NAME_WITH_PREFIX2} to {B_DEF_NAME_WITH_PREFIX2}'s {B_BUFF1}!");
...
static const u8 sText_StickyWebSwitchIn[] = _("{B_SCR_NAME_WITH_PREFIX} was caught in a sticky web!");
...
static const u8 sText_BurstingFlames[] = _("The bursting flames hit {B_SCR_NAME_WITH_PREFIX2}!");
...
static const u8 sText_AirBalloonFloat[] = _("{B_SCR_NAME_WITH_PREFIX} floats in the air with its Air Balloon!");
...
static const u8 sText_HealerCure[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY} cured {B_SCR_NAME_WITH_PREFIX2}'s problem!");
static const u8 sText_ReceiverAbilityTakeOver[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} was taken over!");
...
static const u8 sText_DestinyKnotActivates[] = _("{B_SCR_NAME_WITH_PREFIX} fell in love because of the {B_LAST_ITEM}!");
...
static const u8 sText_PressureActivates[] = _("{B_SCR_NAME_WITH_PREFIX} is exerting its pressure!");
static const u8 sText_DarkAuraActivates[] = _("{B_SCR_NAME_WITH_PREFIX} is radiating a dark aura!");
static const u8 sText_FairyAuraActivates[] = _("{B_SCR_NAME_WITH_PREFIX} is radiating a fairy aura!");
static const u8 sText_AuraBreakActivates[] = _("{B_SCR_NAME_WITH_PREFIX} reversed all other Pokémon's auras!");
static const u8 sText_ComatoseActivates[] = _("{B_SCR_NAME_WITH_PREFIX} is drowsing!");
static const u8 sText_ScreenCleanerActivates[] = _("All screens on the field were cleansed!");
static const u8 sText_FetchedPokeBall[] = _("{B_SCR_NAME_WITH_PREFIX} found a {B_LAST_ITEM}!");
static const u8 sText_BattlerAbilityRaisedStat[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} raised its {B_BUFF1}!");
...
static const u8 sText_AsOneEnters[] = _("{B_SCR_NAME_WITH_PREFIX} has two Abilities!");
...
static const u8 sText_MicleBerryActivates[] = _("{B_SCR_NAME_WITH_PREFIX} boosted the accuracy of its next move using {B_LAST_ITEM}!");
static const u8 sText_PkmnShookOffTheTaunt[] = _("{B_SCR_NAME_WITH_PREFIX} shook off the taunt!");
static const u8 sText_PkmnGotOverItsInfatuation[] = _("{B_SCR_NAME_WITH_PREFIX} got over its infatuation!");
...
static const u8 sText_ZMoveResetsStats[] = _("{B_SCR_NAME_WITH_PREFIX} returned its decreased stats to normal using its Z-Power!");
static const u8 sText_ZMoveAllStatsUp[] = _("{B_SCR_NAME_WITH_PREFIX} boosted its stats using its Z-Power!");
static const u8 sText_ZMoveBoostCrit[] = _("{B_SCR_NAME_WITH_PREFIX} boosted its critical-hit ratio using its Z-Power!");
static const u8 sText_ZMoveRestoreHp[] = _("{B_SCR_NAME_WITH_PREFIX} restored its HP using its Z-Power!");
static const u8 sText_ZMoveStatUp[] = _("{B_SCR_NAME_WITH_PREFIX} boosted its stats using its Z-Power!");
static const u8 sText_ZMoveHpSwitchInTrap[] = _("{B_SCR_NAME_WITH_PREFIX}'s HP was restored by the Z-Power!");
...
static const u8 sText_RedCardActivate[] = _("{B_SCR_NAME_WITH_PREFIX} held up its Red Card against {B_ATK_NAME_WITH_PREFIX2}!");
static const u8 sText_EjectButtonActivate[] = _("{B_SCR_NAME_WITH_PREFIX} is switched out with the {B_LAST_ITEM}!");
...
static const u8 sText_BattlerTypeChangedTo[] = _("{B_SCR_NAME_WITH_PREFIX}'s type changed to {B_BUFF1}!");
...
static const u8 sText_SunlightActivatedAbility[] = _("The harsh sunlight activated {B_SCR_NAME_WITH_PREFIX2}'s Protosynthesis!");
static const u8 sText_StatWasHeightened[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_BUFF1} was heightened!");
static const u8 sText_BoosterEnergyActivates[] = _("{B_SCR_NAME_WITH_PREFIX} used its {B_LAST_ITEM} to activate {B_SCR_ACTIVE_ABILITY}!");
static const u8 sText_ElectricTerrainActivatedAbility[] = _("The Electric Terrain activated {B_SCR_NAME_WITH_PREFIX2}'s Quark Drive!");
static const u8 sText_AbilityWeakenedSurroundingMonsStat[] = _("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} weakened the {B_BUFF1} of all surrounding Pokémon!\p");
static const u8 sText_AttackerGainedStrengthFromTheFallen[] = _("{B_SCR_NAME_WITH_PREFIX} gained strength from the fallen!");
...
static const u8 sText_MirrorHerbCopied[] = _("{B_SCR_NAME_WITH_PREFIX} used its Mirror Herb to mirror its opponent's stat changes!");
...
static const u8 sText_ZeroToHeroTransformation[] = _("{B_SCR_NAME_WITH_PREFIX} underwent a heroic transformation!");
static const u8 sText_CommanderActivates[] = _("{B_SCR_NAME_WITH_PREFIX} was swallowed by Dondozo and became Dondozo's commander!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_PKMNREVERTEDTOPRIMAL - BATTLESTRINGS_TABLE_START] = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Primal Reversion! It reverted to its primal state!"),
    ...
    [STRINGID_CLEARAMULETWONTLOWERSTATS - BATTLESTRINGS_TABLE_START] = COMPOUND_STRING("The effects of the {B_LAST_ITEM} held by {B_SCR_NAME_WITH_PREFIX2} prevents its stats from being lowered!"),
    ...
    [STRINGID_BERRYDMGREDUCES - BATTLESTRINGS_TABLE_START] = COMPOUND_STRING("The {B_LAST_ITEM} weakened the damage to {B_SCR_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_BLOCKEDBYSLEEPCLAUSE - BATTLESTRINGS_TABLE_START]          = COMPOUND_STRING("Sleep Clause kept {B_DEF_NAME_WITH_PREFIX2} awake!"),
    [STRINGID_SUPEREFFECTIVETWOFOES - BATTLESTRINGS_TABLE_START]         = COMPOUND_STRING("It's super effective on {B_DEF_NAME_WITH_PREFIX2} and {B_DEF_PARTNER_NAME}!"),
    [STRINGID_NOTVERYEFFECTIVETWOFOES - BATTLESTRINGS_TABLE_START]       = COMPOUND_STRING("It's not very effective on {B_DEF_NAME_WITH_PREFIX2} and {B_DEF_PARTNER_NAME}!"),
    [STRINGID_ITDOESNTAFFECTTWOFOES - BATTLESTRINGS_TABLE_START]         = COMPOUND_STRING("It doesn't affect {B_DEF_NAME_WITH_PREFIX2} and {B_DEF_PARTNER_NAME}…"),
};

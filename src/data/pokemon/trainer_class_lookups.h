const enum TrainerPicID gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_PKMN_TRAINER_BRENDAN]   = TRAINER_PIC_RS_BRENDAN,
    [FACILITY_CLASS_PKMN_TRAINER_BRENDAN_2] = TRAINER_PIC_RS_BRENDAN,
    [FACILITY_CLASS_PKMN_TRAINER_BRENDAN_3] = TRAINER_PIC_RS_BRENDAN,
    [FACILITY_CLASS_PKMN_TRAINER_MAY]       = TRAINER_PIC_RS_MAY,
    [FACILITY_CLASS_PKMN_TRAINER_MAY_2]     = TRAINER_PIC_RS_MAY,
    [FACILITY_CLASS_PKMN_TRAINER_MAY_3]     = TRAINER_PIC_RS_MAY,
    ...
    [FACILITY_CLASS_COOLTRAINER_M]          = TRAINER_PIC_ACE_TRAINER_M,
    [FACILITY_CLASS_COOLTRAINER_F]          = TRAINER_PIC_ACE_TRAINER_F,
    ...
    [FACILITY_CLASS_BRENDAN]                = TRAINER_PIC_RS_BRENDAN,
    [FACILITY_CLASS_MAY]                    = TRAINER_PIC_RS_MAY,
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_COOLTRAINER_M]          = TRAINER_CLASS_ACE_TRAINER,
    [FACILITY_CLASS_COOLTRAINER_F]          = TRAINER_CLASS_ACE_TRAINER,

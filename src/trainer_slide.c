...
static const u8* const sTrainerSlides[DIFFICULTY_COUNT][TRAINER_PARTNER(PARTNER_COUNT)][TRAINER_SLIDE_COUNT] =
{
    [DIFFICULTY_NORMAL] =
    {
        ...
        {
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Not fair!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Ha, ha, ha! Take that!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_SUPER_EFFECTIVE_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Oh, so you know about Types.{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_DOWN] = COMPOUND_STRING("{B_TRAINER1_NAME}: Argh! Useless!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_MON_UNAFFECTED] = COMPOUND_STRING("{B_TRAINER1_NAME}: Ha ha! No chance!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_SWITCHIN] = COMPOUND_STRING("{B_TRAINER1_NAME}: This one's stronger anyway!{PAUSE_UNTIL_PRESS}"),
        },
        ...
        {
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: No way!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Take that! Ha!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_SUPER_EFFECTIVE_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Drat!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_DOWN] = COMPOUND_STRING("{B_TRAINER1_NAME}: That one's too weak!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_MON_UNAFFECTED] = COMPOUND_STRING("{B_TRAINER1_NAME}: Nice try.{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_SWITCHIN] = COMPOUND_STRING("{B_TRAINER1_NAME}: Now you're done for!{PAUSE_UNTIL_PRESS}"),
        },
        ...
        {
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: No way!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Oh, yeah!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_SUPER_EFFECTIVE_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Hey! Stop that!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_DOWN] = COMPOUND_STRING("{B_TRAINER1_NAME}: So {B_OPPONENT_MON1_NAME} couldn't cut it…{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_MON_UNAFFECTED] = COMPOUND_STRING("{B_TRAINER1_NAME}: You really think that would work?{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_SWITCHIN] = COMPOUND_STRING("{B_TRAINER1_NAME}: Okay, that's it!{PAUSE_UNTIL_PRESS}"),
        },
        ...
        {
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Darn it!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Haha! Serves you right!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_SUPER_EFFECTIVE_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Cut that out!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_DOWN] = COMPOUND_STRING("{B_TRAINER1_NAME}: {B_OPPONENT_MON1_NAME} is no good!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_MON_UNAFFECTED] = COMPOUND_STRING("{B_TRAINER1_NAME}: Huh? What was that?{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_SWITCHIN] = COMPOUND_STRING("{B_TRAINER1_NAME}: Let's go, {B_OPPONENT_MON1_NAME}!{PAUSE_UNTIL_PRESS}"),
        },
        ...
        {
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: You just got lucky!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Ha! Critical hit!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_SUPER_EFFECTIVE_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Argh!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_DOWN] = COMPOUND_STRING("{B_TRAINER1_NAME}: I'm just getting started!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_MON_UNAFFECTED] = COMPOUND_STRING("{B_TRAINER1_NAME}: Seriously?{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_SWITCHIN] = COMPOUND_STRING("{B_TRAINER1_NAME}: Okay, you got stronger…{PAUSE_UNTIL_PRESS}"),
        },
        ...
        {
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Rotten luck!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Yeah! Now we're talking!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_SUPER_EFFECTIVE_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Ow!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_DOWN] = COMPOUND_STRING("{B_TRAINER1_NAME}: Not bad!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_MON_UNAFFECTED] = COMPOUND_STRING("{B_TRAINER1_NAME}: Take this seriously!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_SWITCHIN] = COMPOUND_STRING("{B_TRAINER1_NAME}: You're kidding me!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_HALF_HP] = COMPOUND_STRING("{B_TRAINER1_NAME}: I'm not finished!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_LOW_HP] = COMPOUND_STRING("{B_TRAINER1_NAME}: Why, I oughta…{PAUSE_UNTIL_PRESS}"),
        },
        ...
        {
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Oh, come on{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Yes! Critical hit! Ha, ha, ha!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_SUPER_EFFECTIVE_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Arrrgh! You jerk!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_DOWN] = COMPOUND_STRING("{B_TRAINER1_NAME}: Wh-what! Wait a sec!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_MON_UNAFFECTED] = COMPOUND_STRING("{B_TRAINER1_NAME}: Ha! That's not working!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_SWITCHIN] = COMPOUND_STRING("{B_TRAINER1_NAME}: What? How am I down to my last Pokémon?{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_HALF_HP] = COMPOUND_STRING("{B_TRAINER1_NAME}: Whoa, seriously?!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_LOW_HP] = COMPOUND_STRING("{B_TRAINER1_NAME}: What the what?{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_MEGA_EVOLUTION] = COMPOUND_STRING("{B_TRAINER1_NAME}: Betcha didn't expect what's coming!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_Z_MOVE] = COMPOUND_STRING("{B_TRAINER1_NAME}: I'll show you why I'm the strongest Trainer in the world!{PAUSE_UNTIL_PRESS}"),
        },
        ...
        {
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: Man, that's frustrating.{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_LANDS_FIRST_CRITICAL_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: There! Yes!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_SUPER_EFFECTIVE_HIT] = COMPOUND_STRING("{B_TRAINER1_NAME}: You're kidding me!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_DOWN] = COMPOUND_STRING("{B_TRAINER1_NAME}: Gimme a break!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_ENEMY_MON_UNAFFECTED] = COMPOUND_STRING("{B_TRAINER1_NAME}: Wouldn't do that if I were you.{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_SWITCHIN] = COMPOUND_STRING("{B_TRAINER1_NAME}: Heh heh heh… You're unprepared for this. We'll knock you down!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_HALF_HP] = COMPOUND_STRING("{B_TRAINER1_NAME}: Whoa, seriously?!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_LAST_LOW_HP] = COMPOUND_STRING("{B_TRAINER1_NAME}: Am I the one who was unprepared?{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_MEGA_EVOLUTION] = COMPOUND_STRING("{B_TRAINER1_NAME}: Let's show 'em how strong we are… I'm countin' on you, {B_OPPONENT_MON1_NAME}!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_Z_MOVE] = COMPOUND_STRING("{B_TRAINER1_NAME}: I'll teach you just how strong I am! Here I come!{PAUSE_UNTIL_PRESS}"),
        },

...
#define B_SHOW_MOVE_DESCRIPTION     TRUE       // Shows move information in battle
...
#define B_INCAPACITATED_CATCH_BONUS     GEN_LATEST // In Gen5+, the catch rate bonus for a mon with sleep or freeze is 2.5x. In Gen4 and below it's only a 2x bonus.

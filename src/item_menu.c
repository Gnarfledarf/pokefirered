...
enum ItemSortType
{
	...
	ITEM_TYPE_MEMORY,
	ITEM_TYPE_DRIVE,
    ITEM_TYPE_SWORD_SHIELD,
	ITEM_TYPE_MEGA_STONE,
	ITEM_TYPE_INCENSE,
    ITEM_TYPE_CONTEST_SCARF,
	ITEM_TYPE_Z_CRYSTAL,
	ITEM_TYPE_NECTAR,
	ITEM_TYPE_SELLABLE,
	ITEM_TYPE_RELIC,
    ...
    ITEM_TYPE_APRICORN,
    ITEM_TYPE_DYNAMAX,
	ITEM_TYPE_MAIL_BAGSORT, //otherwise conflicts with "ITEM_TYPE_MAIL" in /include/item.h
};
...
//Mints
    [ITEM_LONELY_MINT]      = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_ADAMANT_MINT]     = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_NAUGHTY_MINT]     = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_BRAVE_MINT]       = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_BOLD_MINT]        = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_IMPISH_MINT]      = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_LAX_MINT]         = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_RELAXED_MINT]     = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_MODEST_MINT]      = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_MILD_MINT]        = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_RASH_MINT]        = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_QUIET_MINT]       = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_CALM_MINT]        = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_GENTLE_MINT]      = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_CAREFUL_MINT]     = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_SASSY_MINT]       = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_TIMID_MINT]       = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_HASTY_MINT]       = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_JOLLY_MINT]       = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_NAIVE_MINT]       = ITEM_TYPE_STAT_BOOST_MINT,
    [ITEM_SERIOUS_MINT]     = ITEM_TYPE_STAT_BOOST_MINT,
...
// Escape Items
    ...
    [ITEM_MAX_MUSHROOMS]    = ITEM_TYPE_BATTLE_ITEM,
...
// Treasures
    ...
    [ITEM_STRANGE_SOUVENIR] = ITEM_TYPE_SELLABLE,
...
// Dynamax Items
    [ITEM_WISHING_PIECE]    = ITEM_TYPE_DYNAMAX,
    [ITEM_GALARICA_TWIG]    = ITEM_TYPE_DYNAMAX,
    [ITEM_ARMORITE_ORE]     = ITEM_TYPE_DYNAMAX,
    [ITEM_DYNITE_ORE]       = ITEM_TYPE_DYNAMAX,

// Mail
    [ITEM_ORANGE_MAIL]      = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_HARBOR_MAIL]      = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_GLITTER_MAIL]     = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_MECH_MAIL]        = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_WOOD_MAIL]        = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_WAVE_MAIL]        = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_BEAD_MAIL]        = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_SHADOW_MAIL]      = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_TROPIC_MAIL]      = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_DREAM_MAIL]       = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_FAB_MAIL]         = ITEM_TYPE_MAIL_BAGSORT,
    [ITEM_RETRO_MAIL]       = ITEM_TYPE_MAIL_BAGSORT,
...
// Evolution Items (Other)
    ...
    [ITEM_OVAL_STONE]       = ITEM_TYPE_EVOLUTION_ITEM,
...
// TODO: Better item type name
    [ITEM_RUSTED_SWORD]     = ITEM_TYPE_SWORD_SHIELD,
    [ITEM_RUSTED_SHIELD]    = ITEM_TYPE_SWORD_SHIELD,

// Mega Stones and other form-changing items    
...
// Contest Scarves
    [ITEM_RED_SCARF]        = ITEM_TYPE_CONTEST_SCARF,
    [ITEM_BLUE_SCARF]       = ITEM_TYPE_CONTEST_SCARF,
    [ITEM_PINK_SCARF]       = ITEM_TYPE_CONTEST_SCARF,
    [ITEM_GREEN_SCARF]      = ITEM_TYPE_CONTEST_SCARF,
    [ITEM_YELLOW_SCARF]     = ITEM_TYPE_CONTEST_SCARF,
...
// Species-specific Held Items
    ...
    [ITEM_DEEP_SEA_TOOTH]   = ITEM_TYPE_HELD_ITEM,
    [ITEM_DEEP_SEA_SCALE]   = ITEM_TYPE_HELD_ITEM,
...
// Misc. Held Items
    ...
    [ITEM_KINGS_ROCK]       = ITEM_TYPE_HELD_ITEM,
    ...
    [ITEM_RAZOR_CLAW]       = ITEM_TYPE_HELD_ITEM,
    [ITEM_RAZOR_FANG]       = ITEM_TYPE_HELD_ITEM,
...
static void AddBagSortSubMenu(void)
{
    ...
    PrintMenuActionTexts(windowId, 2, GetMenuCursorDimensionByFont(2, 0), 4, GetFontAttribute(2, FONTATTR_LETTER_SPACING), GetFontAttribute(2, FONTATTR_MAX_LETTER_HEIGHT) + 2, sContextMenuNumItems, sItemMenuContextActions, sContextMenuItemsPtr);
    InitMenuNormal              (windowId, 2, 0, 2, GetFontAttribute(2, FONTATTR_MAX_LETTER_HEIGHT) + 2, sContextMenuNumItems, 0);
}

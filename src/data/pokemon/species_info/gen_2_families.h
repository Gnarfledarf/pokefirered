...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .frontPic = gMonFrontPic_Togepi,
            ...
            .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_SWING_CONCAVE : ANIM_SWING_CONCAVE,
        #endif
    ...
    [SPECIES_TOGEKISS] =
    {
        ...
        .description = COMPOUND_STRING(
        #ifdef FIRERED
            "It will never appear where there is strife.\n"
            "Its sightings have become rare recently."
        #else
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
        #ifdef FIRERED
            "Excess energy from Mega Evolution stimulates\n"
            "its genes, and the wool it had lost grows in again."
        #else
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "It leaks water from its eyes to\n"
    ...
    [SPECIES_AMBIPOM] =
    {
        ...
        .description = COMPOUND_STRING(
        #ifdef FIRERED
            "To eat, it deftly shucks nuts with its\n"
            "two tails. It rarely uses its arms now."
        #else
            "They work in large colonies and\n"
            "make rings by linking their tails,\n"
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        #else
            "Its jaw power is incredible.\n"
            "It is adept at biting apart foes\n"
    ...
    [SPECIES_WOOPER_PALDEA] =
    {
        ...
        #else
            "It's dangerous for Paldean Wooper to\n"
            "travel alone. They line up in groups of\n"
            "three or four and help each other as\n"
            "they walk around the wetlands."
        #endif
        ),
        .pokemonScale = 479,
        .pokemonOffset = 21,
    ...
    [SPECIES_CLODSIRE] =
    {
        ...
        #else
            "It lives at the bottom of ponds and swamps.\n"
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        #else
            "It makes its Murkrow cronies bring\n"
            "it food. It idles its time away,\n"
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .frontPic = gMonFrontPic_Forretress,
            ...
            .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 9 : 9,
            .frontAnimFrames = ANIM_FRAMES(
                ANIMCMD_FRAME(1, 10),
                ANIMCMD_FRAME(0, 10),
                ANIMCMD_FRAME(1, 10),
    ...
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] =
    {
        ...
        .description = COMPOUND_STRING(
        #ifdef FIRERED
            "The gentle Dudunsparce will put Pokémon\n"
            "that wander into its nest onto its back\n"
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "breeze properly, it can circle the\n"
            "globe without flapping once."
        #endif
        ),
        .pokemonScale = 261,
        .pokemonOffset = 1,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "its body by drinking over ten liters of \n"
            "water all at once."
        #endif
        ),
        .pokemonScale = 430,
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .description = COMPOUND_STRING(
        #ifdef FIRERED
            "It lives just offshore in cold parts\n"
            "of the world. Its poisonous spikes\n"
            "are thicker and shorter than those\n"
            "of other regions’ Qwilfish."
        #else
    ...
    [SPECIES_OVERQWIL] =
    {
        ...
        .description = COMPOUND_STRING(
        #ifdef FIRERED
            "Overqwil’s poisonous spikes will reflexively\n"
            "react even while Overqwil sleeps, stabbing\n"
            "any moving thing that approaches."
        #else
            "It’s ferocious and has a short temper.\n"
            "The ends of its spikes are barbed, and\n"
            "they can’t be easily removed once\n"
            "they’ve punctured something."
        #endif
        ),
        .pokemonScale = 257,
        .pokemonOffset = 10,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .frontPic = gMonFrontPic_Heracross,
            ...
            .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_LUNGE_GROW : ANIM_LUNGE_GROW,
        #endif
    ...
    [SPECIES_HERACROSS_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
        #ifdef FIRERED
            "It can grip things with its two horns\n"
            "and lift 500 times its own body weight."
        #else
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "by carving odd patterns in\n"
            "frost-covered trees and ice."
        #endif
        ),
        .pokemonScale = 320,
        .pokemonOffset = 7,
    ...
    [SPECIES_URSALUNA_BLOODMOON] =
    {
        ...
        #else
            "This special Ursaluna can see in the\n"
            "dark with its left eye and protects\n"
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .frontPic = gMonFrontPic_Slugma,
            ...
            .frontAnimId = ANIM_V_STRETCH,
        #else
            .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(32, 40),
            .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 13 : 13,
            .frontAnimFrames = ANIM_FRAMES(
                ANIMCMD_FRAME(0, 10),
                ANIMCMD_FRAME(1, 10),
                ANIMCMD_FRAME(0, 10),
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .frontPic = gMonFrontPic_Magcargo,
            ...
            .frontAnimId = ANIM_V_STRETCH,
        #else
            .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(40, 56) : MON_COORDS_SIZE(40, 56),
            .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 13 : 13,
            .frontAnimFrames = ANIM_FRAMES(
                ANIMCMD_FRAME(0, 10),
                ANIMCMD_FRAME(1, 10),
    ...
    [SPECIES_CORSOLA_GALAR] =
    {
        ...
        .description = COMPOUND_STRING(
        #ifdef FIRERED
            "Watch your step when wandering areas\n"
            "oceans once covered. What looks like a\n"
            "stone could be this Pokémon, and it will\n"
            "curse you if you kick it."
        #else
            "Sudden climate change wiped out this\n"
            "ancient kind of Corsola. This\n"
            "Pokémon absorbs others' life-force.\n"
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        #else
            .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(40, 48),
            .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 8 : 8,
            .frontAnimFrames = ANIM_FRAMES(
                ANIMCMD_FRAME(1, 15),
                ANIMCMD_FRAME(0, 15),
            ),
            .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_V_JUMPS_SMALL : ANIM_V_JUMPS_SMALL,
        #endif
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "subtle flows of seawater using its\n"
            "two antennae."
        #else
            "Scientists discovered that\n"
            "the distinctive patterns on\n"
            "its back differ by region."
        #endif
        ),
        .pokemonScale = 305,
        .pokemonOffset = 7,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .frontPic = gMonFrontPic_Mantine,
            ...
            .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 1 : 1,
            .frontAnimFrames = ANIM_FRAMES(
                ANIMCMD_FRAME(1, 30),
                ANIMCMD_FRAME(0, 30),
                ANIMCMD_FRAME(1, 30),
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .frontPic = gMonFrontPic_Skarmory,
            ...
            .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_V_STRETCH : ANIM_V_STRETCH,
        #endif
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        #else
            "Houndoom's entire body generates heat\n"
            "when it Mega Evolves. Its fearsome fiery\n"
            "breath turns its opponents to ash."
        #endif
        ),
        .pokemonScale = 256,
        .pokemonOffset = 4,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .frontPic = gMonFrontPic_Donphan,
            ...
            .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_V_SHAKE_TWICE : ANIM_V_SHAKE_TWICE,
        #endif
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .frontPic = gMonFrontPic_Smeargle,
        ...
        #else
            .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(56, 56),
            .frontPicYOffset = 6,
            .frontAnimFrames = ANIM_FRAMES(
                ANIMCMD_FRAME(1, 12),
                ANIMCMD_FRAME(0, 12),
            ...
            .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_H_JUMPS : ANIM_H_JUMPS,
        #endif
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .frontPic = gMonFrontPic_Larvitar,
            ...
            .frontAnimId = ANIM_V_JUMPS_SMALL,
        #else
            .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(32, 48) : MON_COORDS_SIZE(32, 48),
            .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 9 : 9,
            .frontAnimFrames = ANIM_FRAMES(
                ANIMCMD_FRAME(1, 10),
                ANIMCMD_FRAME(0, 10),
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .frontPic = gMonFrontPic_Pupitar,
            ...
            .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_V_SHAKE : ANIM_V_SHAKE,
        #endif
    ...
    [SPECIES_TYRANITAR_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "ferocious than ever. It's unclear whether it\n"
            "can even hear its Trainer's orders."
        #endif
        ),
        .pokemonScale = 256,
        .pokemonOffset = 0,

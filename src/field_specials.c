...
{
    COMPOUND_STRING("Energy Powder{CLEAR_TO 0x74}{FONT_SMALL}50"),
    ...
    COMPOUND_STRING("Zince{CLEAR_TO 0x65}{FONT_SMALL}1,000"),
...
static const u8 *const sScrollMultiLabels_BFMoveTutor1[] =
{
    ...
    COMPOUND_STRING("Seismis Toss{CLEAR_TO 0x4E}24BP"),
        ...
        */
        ...
        if (birdCount > 0)
        {
            ...
            for (i = 0; i < visibleCount; i++)
            {
                ...
                u32 speciesId = template->graphicsId - OBJ_EVENT_MON_SPECIES_MASK;

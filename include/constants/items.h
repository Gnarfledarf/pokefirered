...
enum __attribute__((packed)) Item
{
    ...
    // Charms
    ITEM_OVAL_CHARM = 725,
    ITEM_SHINY_CHARM = 726,
    ITEM_CATCHING_CHARM = 727,
    ITEM_EXP_CHARM = 728,

    // Form-changing Key Items
    ITEM_ROTOM_CATALOG = 729,
    ITEM_GRACIDEA = 730,
    ITEM_REVEAL_GLASS = 731,
    ITEM_DNA_SPLICERS = 732,
    ITEM_ZYGARDE_CUBE = 733,
    ITEM_PRISON_BOTTLE = 734,
    ITEM_N_SOLARIZER = 735,
    ITEM_N_LUNARIZER = 736,
    ITEM_REINS_OF_UNITY = 737,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 738,
    ITEM_Z_POWER_RING = 739,
    ITEM_DYNAMAX_BAND = 740,
    ...
    ITEM_GOOD_ROD = 745,
    ITEM_SUPER_ROD = 746,
    ITEM_DOWSING_MACHINE = 747,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen IV name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen IV-V name
    ITEM_TOWN_MAP = 748,
    ITEM_VS_SEEKER = 749,
    ITEM_TM_CASE = 750,
    ITEM_BERRY_POUCH = 751,
    ITEM_POKEMON_BOX_LINK = 752,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Pre-Gen VIII name
    ITEM_COIN_CASE = 753,
    ITEM_POWDER_JAR = 754,
    ITEM_WAILMER_PAIL = 755,
    ITEM_POKE_RADAR = 756,
    ITEM_POKEBLOCK_CASE = 757,
    ITEM_SOOT_SACK = 758,
    ITEM_POKE_FLUTE = 759,
    ITEM_FAME_CHECKER = 760,
    ITEM_TEACHY_TV = 761,

    // Story Key Items
    ITEM_SS_TICKET = 762,
    ITEM_EON_TICKET = 763,
    ITEM_MYSTIC_TICKET = 764,
    ITEM_AURORA_TICKET = 765,
    ITEM_OLD_SEA_MAP = 766,
    ITEM_LETTER = 767,
    ITEM_DEVON_PARTS = 768,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 769,
    ITEM_DEVON_SCOPE = 770,
    ITEM_BASEMENT_KEY = 771,
    ITEM_SCANNER = 772,
    ITEM_STORAGE_KEY = 773,
    ITEM_KEY_TO_ROOM_1 = 774,
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_2 = 775,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_4 = 776,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_6 = 777,
    ITEM_RM_6_KEY = ITEM_KEY_TO_ROOM_6, // Pre-Gen VI name
    ITEM_METEORITE = 778,
    ITEM_MAGMA_EMBLEM = 779,
    ITEM_CONTEST_PASS = 780,
    ITEM_PARCEL = 781,
    ITEM_OAKS_PARCEL = ITEM_PARCEL, // Pre-Gen IV name
    ITEM_SECRET_KEY = 782,
    ITEM_BIKE_VOUCHER = 783,
    ITEM_GOLD_TEETH = 784,
    ITEM_CARD_KEY = 785,
    ITEM_LIFT_KEY = 786,
    ITEM_SILPH_SCOPE = 787,
    ITEM_TRI_PASS = 788,
    ITEM_RAINBOW_PASS = 789,
    ITEM_TEA = 790,
    ITEM_RUBY = 791,
    ITEM_SAPPHIRE = 792,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 793,
    ITEM_CLEAR_AMULET = 794,
    ITEM_PUNCHING_GLOVE = 795,
    ITEM_COVERT_CLOAK = 796,
    ITEM_LOADED_DICE = 797,
    ITEM_AUSPICIOUS_ARMOR = 798,
    ITEM_BOOSTER_ENERGY = 799,
    ITEM_BIG_BAMBOO_SHOOT = 800,
    ITEM_GIMMIGHOUL_COIN = 801,
    ITEM_LEADERS_CREST = 802,
    ITEM_MALICIOUS_ARMOR = 803,
    ITEM_MIRROR_HERB = 804,
    ITEM_SCROLL_OF_DARKNESS = 805,
    ITEM_SCROLL_OF_WATERS = 806,
    ITEM_TERA_ORB = 807,
    ITEM_TINY_BAMBOO_SHOOT = 808,

    ITEM_BUG_TERA_SHARD = 809,
    ITEM_DARK_TERA_SHARD = 810,
    ITEM_DRAGON_TERA_SHARD = 811,
    ITEM_ELECTRIC_TERA_SHARD = 812,
    ITEM_FAIRY_TERA_SHARD = 813,
    ITEM_FIGHTING_TERA_SHARD = 814,
    ITEM_FIRE_TERA_SHARD = 815,
    ITEM_FLYING_TERA_SHARD = 816,
    ITEM_GHOST_TERA_SHARD = 817,
    ITEM_GRASS_TERA_SHARD = 818,
    ITEM_GROUND_TERA_SHARD = 819,
    ITEM_ICE_TERA_SHARD = 820,
    ITEM_NORMAL_TERA_SHARD = 821,
    ITEM_POISON_TERA_SHARD = 822,
    ITEM_PSYCHIC_TERA_SHARD = 823,
    ITEM_ROCK_TERA_SHARD = 824,
    ITEM_STEEL_TERA_SHARD = 825,
    ITEM_WATER_TERA_SHARD = 826,

    ITEM_ADAMANT_CRYSTAL = 827,
    ITEM_GRISEOUS_CORE = 828,
    ITEM_LUSTROUS_GLOBE = 829,

    ITEM_BLACK_AUGURITE = 830,
    ITEM_LINKING_CORD = 831,
    ITEM_PEAT_BLOCK = 832,
    ITEM_BERSERK_GENE = 833,

    ITEM_FAIRY_FEATHER = 834,
    ITEM_SYRUPY_APPLE = 835,
    ITEM_UNREMARKABLE_TEACUP = 836,
    ITEM_MASTERPIECE_TEACUP = 837,
    ITEM_CORNERSTONE_MASK = 838,
    ITEM_WELLSPRING_MASK = 839,
    ITEM_HEARTHFLAME_MASK = 840,
    ITEM_HEALTH_MOCHI = 841,
    ITEM_MUSCLE_MOCHI = 842,
    ITEM_RESIST_MOCHI = 843,
    ITEM_GENIUS_MOCHI = 844,
    ITEM_CLEVER_MOCHI = 845,
    ITEM_SWIFT_MOCHI = 846,
    ITEM_FRESH_START_MOCHI = 847,
    ITEM_GLIMMERING_CHARM = 848,
    ITEM_METAL_ALLOY = 849,
    ITEM_STELLAR_TERA_SHARD = 850,

    ITEM_JUBILIFE_MUFFIN = 851,
    ITEM_REMEDY = 852,
    ITEM_FINE_REMEDY = 853,
    ITEM_SUPERB_REMEDY = 854,
    ITEM_AUX_EVASION = 855,
    ITEM_AUX_GUARD = 856,
    ITEM_AUX_POWER = 857,
    ITEM_AUX_POWERGUARD = 858,
    ITEM_CHOICE_DUMPLING = 859,
    ITEM_SWAP_SNACK = 860,
    ITEM_TWICE_SPICED_RADISH = 861,
    ITEM_POKESHI_DOLL = 862,

    ITEM_STRANGE_BALL = 863,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 864,
    ITEM_VICTREEBELITE = 865,
    ITEM_STARMINITE = 866,
    ITEM_DRAGONINITE = 867,
    ITEM_MEGANIUMITE = 868,
    ITEM_FERALIGITE = 869,
    ITEM_SKARMORITE = 870,
    ITEM_FROSLASSITE = 871,
    ITEM_EMBOARITE = 872,
    ITEM_EXCADRITE = 873,
    ITEM_SCOLIPITE = 874,
    ITEM_SCRAFTINITE = 875,
    ITEM_EELEKTROSSITE = 876,
    ITEM_CHANDELURITE = 877,
    ITEM_CHESNAUGHTITE = 878,
    ITEM_DELPHOXITE = 879,
    ITEM_GRENINJITE = 880,
    ITEM_PYROARITE = 881,
    ITEM_FLOETTITE = 882,
    ITEM_MALAMARITE = 883,
    ITEM_BARBARACITE = 884,
    ITEM_DRAGALGITE = 885,
    ITEM_HAWLUCHANITE = 886,
    ITEM_ZYGARDITE = 887,
    ITEM_DRAMPANITE = 888,
    ITEM_FALINKSITE = 889,
    ...
    ITEM_DARKRANITE = 891,
    ITEM_ZERAORITE = 892,
    ITEM_RAICHUNITE_X = 893,
    ITEM_RAICHUNITE_Y = 894,
    ITEM_CHIMECHITE = 895,
    ITEM_ABSOLITE_Z = 896,
    ITEM_STARAPTITE = 897,
    ITEM_GARCHOMPITE_Z = 898,
    ITEM_LUCARIONITE_Z = 899,
    ITEM_GOLURKITE = 900,
    ITEM_MEOWSTICITE = 901,
    ITEM_CRABOMINITE = 902,
    ITEM_GOLISOPITE = 903,
    ITEM_MAGEARNITE = 904,
    ITEM_SCOVILLAINITE = 905,
    ITEM_BAXCALIBRITE = 906,
    ITEM_TATSUGIRINITE = 907,
    ITEM_GLIMMORANITE = 908,

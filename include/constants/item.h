...
#define POCKET_TREASURES    4
#define POCKET_KEY_ITEMS    5
#define POCKET_POKE_BALLS   6
#define POCKET_TM_HM        7
#define POCKET_BERRIES      8
#define NUM_BAG_POCKETS     8
#define NUM_BAG_POCKETS_NO_CASES 6 // number of pockets without considering TM case or berry pouch

#define ITEMS_POCKET        0
#define MEDICINE_POCKET     1
#define BATTLEITEMS_POCKET  2
#define TREASURES_POCKET    3
#define KEYITEMS_POCKET     4
#define BALLS_POCKET        5
#define TMHM_POCKET         6
#define BERRIES_POCKET      7
